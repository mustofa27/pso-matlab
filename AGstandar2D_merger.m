...
Psilang     = 0.8;   % 0.8;            % Probabilitas pindah silang
Pmutasi     = 0.3;       % 0.3;            % Probabilitas mutasi
...
plot (g,FitnessNN, 'blue',g,FitnessGA, 'red');
legend ('NN', 'GA');
